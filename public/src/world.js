...
const PUZZLES={
  math:{
    1:[ // CẤP 1 — Tân Binh (6-7 tuổi): Đếm, cộng trừ trong 10, so sánh
      {type:'mcq',q:'🍎 3 + 2 = ?',opts:['4','5','6','7'],ans:1},
      {type:'mcq',q:'🌟 7 - 3 = ?',opts:['3','4','5','6'],ans:1},
      {type:'mcq',q:'🐣 Bạn có 5 quả táo, ăn 2 quả. Còn lại mấy quả?',opts:['2','3','4','5'],ans:1},
      {type:'mcq',q:'🎈 4 + 4 = ?',opts:['6','7','8','9'],ans:2},
      {type:'mcq',q:'🐸 9 - 5 = ?',opts:['3','4','5','6'],ans:1},
      {type:'mcq',q:'🍭 2 + 6 = ?',opts:['6','7','8','9'],ans:2},
      {type:'mcq',q:'⚖️ So sánh: 7 ___ 5',opts:['< (nhỏ hơn)','> (lớn hơn)','= (bằng)','Không so sánh được'],ans:1},
      {type:'mcq',q:'⚖️ So sánh: 4 ___ 4',opts:['< (nhỏ hơn)','> (lớn hơn)','= (bằng)','Không xác định'],ans:2},
      {type:'mcq',q:'⚖️ Số nào LỚN HƠN: 3 hay 8?',opts:['3','8','Bằng nhau','Không biết'],ans:1},
      {type:'mcq',q:'⚖️ Số nào NHỎ HƠN: 6 hay 2?',opts:['6','2','Bằng nhau','Không so được'],ans:1},
      {type:'mcq',q:'🌈 Điền dấu đúng: 5 ___ 9',opts:['<','=','>','≠'],ans:0},
      {type:'mcq',q:'🌈 Điền dấu đúng: 10 ___ 7',opts:['<','=','>','≠'],ans:2},
    ...
    2:[ // CẤP 2 — Chiến Binh (7-8 tuổi): Cộng trừ trong 20, so sánh số, bảng 2,3,4,5
      {type:'mcq',q:'🔢 8 + 7 = ?',opts:['13','14','15','16'],ans:2},
      {type:'mcq',q:'🌟 17 - 8 = ?',opts:['7','8','9','10'],ans:2},
      {type:'mcq',q:'🍭 5 × 2 = ?',opts:['7','8','10','12'],ans:2},
      {type:'mcq',q:'🐸 4 × 3 = ?',opts:['10','11','12','13'],ans:2},
      {type:'mcq',q:'🎈 5 × 5 = ?',opts:['20','23','25','30'],ans:2},
      {type:'mcq',q:'⚖️ So sánh: 15 ___ 12',opts:['<','=','>','Không xác định'],ans:2},
      {type:'mcq',q:'⚖️ So sánh: 9 + 3 ___ 11',opts:['<','=','>','Không so được'],ans:2},
      {type:'mcq',q:'⚖️ So sánh: 4 × 2 ___ 10',opts:['<','=','>','≠'],ans:0},
      {type:'mcq',q:'⚖️ Số nào LỚN HƠN: 13 hay 17?',opts:['13','17','Bằng nhau','Không biết'],ans:1},
    ...
    3:[ // CẤP 3 — Anh Hùng (8-9 tuổi): Nhân chia bảng cửu chương, so sánh biểu thức
      {type:'mcq',q:'🔢 6 × 7 = ?',opts:['40','42','45','48'],ans:1},
      {type:'mcq',q:'➗ 32 ÷ 4 = ?',opts:['6','7','8','9'],ans:2},
      {type:'mcq',q:'🔢 9 × 8 = ?',opts:['70','72','74','76'],ans:1},
      {type:'mcq',q:'➗ 63 ÷ 9 = ?',opts:['6','7','8','9'],ans:1},
      {type:'mcq',q:'⚖️ So sánh: 7 × 6 ___ 40',opts:['<','=','>','Không so được'],ans:2},
      {type:'mcq',q:'⚖️ So sánh: 56 ÷ 8 ___ 9',opts:['<','=','>','≠'],ans:0},
      ...
      {type:'mcq',q:'🧮 Tính: 4 × 8 + 5 = ?',opts:['37','39','41','45'],ans:0},
      {type:'mcq',q:'📐 Hình vuông cạnh 4cm. Chu vi là?',opts:['12cm','14cm','16cm','18cm'],ans:2},
    ...
    4:[ // CẤP 4 — Huyền Thoại (9-10 tuổi): Phân số, so sánh phân số, số thập phân
      ...
      {type:'mcq',q:'📐 Hình chữ nhật dài 8cm, rộng 5cm. Chu vi là?',opts:['26cm','28cm','30cm','32cm'],ans:0},
      {type:'mcq',q:'🔢 3/4 của 20 = ?',opts:['12','15','16','18'],ans:1},
      {type:'mcq',q:'⚖️ So sánh phân số: 1/2 ___ 1/3',opts:['<','=','>','Không so được'],ans:2},
      {type:'mcq',q:'⚖️ So sánh: 3/4 ___ 2/4',opts:['<','=','>','≠'],ans:2},
      {type:'mcq',q:'⚖️ Phân số nào LỚN HƠN: 2/5 hay 3/5?',opts:['2/5','3/5','Bằng nhau','Không so được'],ans:1},
      {type:'mcq',q:'⚖️ So sánh: 0,5 ___ 1/2',opts:['<','=','>','≠'],ans:1},
      {type:'mcq',q:'🔢 0,5 × 4 = ?',opts:['1,5','2','2,5','3'],ans:1},
      {type:'mcq',q:'📊 Trung bình cộng của 6, 8, 10 là?',opts:['7','8','9','10'],ans:1},
    ...
    5:[ // CẤP 5 — Thần Thánh (10 tuổi): Bài toán có lời văn, so sánh nâng cao
      {type:'mcq',q:'🍎 Lan có 24 cái kẹo, chia đều cho 4 bạn. Mỗi bạn được mấy cái?',opts:['4','5','6','8'],ans:2},
      {type:'mcq',q:'🛒 Mua 3 cuốn sách, mỗi cuốn 12.000đ. Tổng tiền là?',opts:['24.000đ','36.000đ','48.000đ','60.000đ'],ans:1},
      {type:'mcq',q:'⚖️ So sánh: 4 × 9 ___ 3 × 12',opts:['<','=','>','≠'],ans:1},
      {type:'mcq',q:'⚖️ So sánh: 100 - 35 ___ 70 - 5',opts:['<','=','>','≠'],ans:1},
      {type:'mcq',q:'⚖️ Số nào BẰNG: 2 × 15 hay 3 × 10?',opts:['2×15 lớn hơn','3×10 lớn hơn','Chúng bằng nhau','Không so được'],ans:2},
      {type:'mcq',q:'🔢 Tìm x: x + 15 = 30',opts:['x=10','x=12','x=15','x=20'],ans:2},
      {type:'mcq',q:'📐 Vườn hình vuông cạnh 7m. Chu vi là?',opts:['21m','28m','35m','42m'],ans:1},
      {type:'mcq',q:'⏰ Có 3 giờ = ? phút',opts:['120 phút','150 phút','180 phút','200 phút'],ans:2},
  ...
  geo:{
    1:[ // CẤP 1 — Tân Binh (6-7 tuổi): Xung quanh em
      {type:'mcq',q:'☀️ Mặt trời mọc ở hướng nào?',opts:['Tây','Nam','Đông','Bắc'],ans:2},
      {type:'mcq',q:'🌙 Ban đêm trên bầu trời có gì sáng?',opts:['Mặt trời','Mặt trăng','Cầu vồng','Sao băng'],ans:1},
      {type:'mcq',q:'🌧️ Khi nào trời mưa?',opts:['Trời nắng đẹp','Trời có mây đen','Trời có gió nhẹ','Ban đêm'],ans:1},
      {type:'mcq',q:'🌏 Thủ đô của Việt Nam là?',opts:['Huế','Đà Nẵng','Hà Nội','Sài Gòn'],ans:2},
      {type:'mcq',q:'🗺️ Nước Việt Nam nằm ở châu lục nào?',opts:['Châu Phi','Châu Âu','Châu Á','Châu Mỹ'],ans:2},
      {type:'mcq',q:'🌊 Biển ở phía Đông Việt Nam gọi là?',opts:['Biển Đỏ','Biển Đông','Biển Đen','Biển Bắc'],ans:1},
      {type:'mcq',q:'🌈 Cầu vồng xuất hiện sau khi nào?',opts:['Mưa','Tuyết','Bão','Sấm'],ans:0},
    ...
    2:[ // CẤP 2 — Chiến Binh (7-8 tuổi): Việt Nam cơ bản
      ...
      {type:'mcq',q:'🌊 Sông nào dài nhất Việt Nam?',opts:['Sông Hồng','Sông Mã','Sông Cửu Long','Sông Đà'],ans:2},
      {type:'mcq',q:'🏙️ Thành phố lớn nhất Việt Nam là?',opts:['Hà Nội','Đà Nẵng','Hải Phòng','TP.Hồ Chí Minh'],ans:3},
      {type:'mcq',q:'🌴 Đồng bằng nào rộng nhất Việt Nam?',opts:['Đồng bằng sông Hồng','Đồng bằng sông Cửu Long','Đồng bằng miền Trung','Đồng bằng Thanh Hóa'],ans:1},
      {type:'mcq',q:'🗺️ Việt Nam có bao nhiêu tỉnh thành?',opts:['58','60','63','65'],ans:2},
      {type:'mcq',q:'🌤️ Miền Nam Việt Nam có mấy mùa?',opts:['2 mùa (mưa và khô)','3 mùa','4 mùa','Chỉ 1 mùa'],ans:0},
    ...
    3:[ // CẤP 3 — Anh Hùng (8-9 tuổi): Châu Á và thế giới cơ bản
      {type:'mcq',q:'🗾 Thủ đô Nhật Bản là?',opts:['Osaka','Seoul','Tokyo','Beijing'],ans:2},
      {type:'mcq',q:'🌏 Sông nào dài nhất thế giới?',opts:['Amazon','Nile','Dương Tử','Mississippi'],ans:1},
      {type:'mcq',q:'🏔️ Đỉnh núi cao nhất thế giới là?',opts:['K2','Everest','Fuji','Kilimanjaro'],ans:1},
      {type:'mcq',q:'🌊 Đại dương nào lớn nhất thế giới?',opts:['Đại Tây Dương','Ấn Độ Dương','Thái Bình Dương','Bắc Băng Dương'],ans:2},
      {type:'mcq',q:'🗺️ Đất nước nào có diện tích lớn nhất thế giới?',opts:['Canada','Trung Quốc','Mỹ','Nga'],ans:3},
      {type:'mcq',q:'🌍 Châu nào có nhiều nước nhất?',opts:['Châu Á','Châu Âu','Châu Phi','Châu Mỹ'],ans:2},
    ...
    4:[ // CẤP 4 — Huyền Thoại (9-10 tuổi): Kiến thức địa lý mở rộng
      {type:'mcq',q:'🌡️ Vùng nào của Trái Đất nóng nhất?',opts:['Vùng cực','Vùng ôn đới','Vùng xích đạo','Vùng sa mạc'],ans:2},
      {type:'mcq',q:'🏔️ Dãy Alps nằm ở châu nào?',opts:['Châu Á','Châu Phi','Châu Âu','Châu Mỹ'],ans:2},
      {type:'mcq',q:'🌊 Eo biển nào ngăn cách châu Á và châu Mỹ?',opts:['Eo Malacca','Eo Bering','Eo Gibraltar','Eo Hormuz'],ans:1},
      {type:'mcq',q:'🗺️ Sa mạc Sahara nằm ở châu nào?',opts:['Châu Á','Châu Mỹ','Châu Phi','Châu Úc'],ans:2},
      {type:'mcq',q:'🌏 Nước nào đông dân nhất thế giới?',opts:['Mỹ','Ấn Độ','Trung Quốc','Indonesia'],ans:1},
      {type:'mcq',q:'🏝️ Đảo nào lớn nhất thế giới?',opts:['Borneo','Greenland','New Guinea','Sumatra'],ans:1},
      ...
      {type:'mcq',q:'🌐 Kinh tuyến 0° đi qua thành phố nào?',opts:['London','Paris','Rome','Berlin'],ans:0},
    ],
    5:[ // CẤP 5 — Thần Thánh (10 tuổi): Địa lý nâng cao
      {type:'mcq',q:'🌋 Núi lửa nào nổi tiếng nhất Nhật Bản?',opts:['Aso','Fuji','Unzen','Sakurajima'],ans:1},
      {type:'mcq',q:'🌊 Đại dương nào nhỏ nhất thế giới?',opts:['Ấn Độ Dương','Đại Tây Dương','Bắc Băng Dương','Nam Đại Dương'],ans:2},
      {type:'mcq',q:'🗺️ Sông Amazon chảy qua nước nào là chủ yếu?',opts:['Argentina','Colombia','Brazil','Peru'],ans:2},
      {type:'mcq',q:'🌍 Lục địa nào không có người ở thường xuyên?',opts:['Châu Đại Dương','Châu Nam Cực','Châu Phi','Châu Á'],ans:1},
      {type:'mcq',q:'🏔️ Everest nằm trên biên giới 2 nước nào?',opts:['Trung Quốc-Ấn Độ','Nepal-Ấn Độ','Nepal-Trung Quốc','Bhutan-Trung Quốc'],ans:2},
      {type:'mcq',q:'🌊 Hồ nào lớn nhất thế giới?',opts:['Hồ Superior','Hồ Victoria','Hồ Baikal','Biển Caspi'],ans:3},
      ...
      {type:'mcq',q:'🌐 Múi giờ Việt Nam là UTC+?',opts:['+5','+6','+7','+8'],ans:2},
    ],
  },

  history:{
    1:[ // CẤP 1 — Tân Binh (6-7 tuổi): Lịch sử cơ bản
      {type:'mcq',q:'🇻🇳 Thủ đô của Việt Nam là?',opts:['Sài Gòn','Đà Nẵng','Hà Nội','Huế'],ans:2},
      {type:'mcq',q:'👨‍👩‍👧 Ai được gọi là "Cha già dân tộc" của Việt Nam?',opts:['Vua Hùng','Bác Hồ','Trần Hưng Đạo','Lê Lợi'],ans:1},
      {type:'mcq',q:'🎉 Ngày Quốc khánh Việt Nam là ngày nào?',opts:['30/4','2/9','19/5','1/1'],ans:1},
      {type:'mcq',q:'🏯 Lá cờ Việt Nam có màu gì?',opts:['Xanh và vàng','Đỏ và vàng','Đỏ và trắng','Vàng và trắng'],ans:1},
      {type:'mcq',q:'⚔️ Hai Bà Trưng là những anh hùng nào?',opts:['Hai người đàn ông','Hai người phụ nữ','Hai vị vua','Hai vị tướng nam'],ans:1},
      {type:'mcq',q:'🌟 Ngày 30/4 là ngày gì?',opts:['Quốc khánh','Giải phóng miền Nam','Ngày lao động','Tết Nguyên Đán'],ans:1},
    ...
    2:[ // CẤP 2 — Chiến Binh (7-8 tuổi)
      {type:'mcq',q:'🏹 Lê Lợi khởi nghĩa chống lại quân nào?',opts:['Quân Thanh','Quân Minh','Quân Tống','Quân Nguyên'],ans:1},
      {type:'mcq',q:'⚔️ Ai đánh tan 29 vạn quân Thanh năm 1789?',opts:['Gia Long','Nguyễn Ánh','Quang Trung','Lê Lợi'],ans:2},
      {type:'mcq',q:'🌊 Trận Bạch Đằng năm 938 do ai chỉ huy?',opts:['Đinh Bộ Lĩnh','Ngô Quyền','Lý Thái Tổ','Trần Hưng Đạo'],ans:1},
      {type:'mcq',q:'🗺️ Chiến thắng Điện Biên Phủ năm nào?',opts:['1945','1954','1968','1975'],ans:1},
      {type:'mcq',q:'📜 Ai viết "Nam quốc sơn hà"?',opts:['Nguyễn Trãi','Lý Thường Kiệt','Trần Hưng Đạo','Lê Lợi'],ans:1},
      {type:'mcq',q:'🏯 Ai lập ra nhà Nguyễn?',opts:['Minh Mạng','Tự Đức','Gia Long','Thiệu Trị'],ans:2},
    ...
    3:[ // CẤP 3 — Anh Hùng (8-9 tuổi)
      {type:'mcq',q:'📜 "Bình Ngô Đại Cáo" do ai viết?',opts:['Lê Lợi','Nguyễn Trãi','Trần Hưng Đạo','Lý Thường Kiệt'],ans:1},
      {type:'mcq',q:'🏹 Khởi nghĩa Yên Thế do ai lãnh đạo?',opts:['Phan Bội Châu','Hoàng Hoa Thám','Phan Chu Trinh','Nguyễn Thái Học'],ans:1},
      {type:'mcq',q:'🌟 Đảng Cộng sản Việt Nam thành lập năm nào?',opts:['1925','1930','1941','1945'],ans:1},
      {type:'mcq',q:'🗺️ Hiệp định Geneva 1954 chia đôi Việt Nam theo vĩ tuyến?',opts:['13°','16°','17°','20°'],ans:2},
      {type:'mcq',q:'🏰 Nhà Lý dời đô về Thăng Long năm nào?',opts:['968','1009','1010','1054'],ans:2},
      {type:'mcq',q:'🐘 Bà Triệu nổi tiếng với hình ảnh nào?',opts:['Cưỡi voi đánh giặc','Bơi qua sông lớn','Cưỡi ngựa bắn tên','Leo núi cao'],ans:0},
    ...
    4:[ // CẤP 4 — Huyền Thoại (9-10 tuổi)
      {type:'mcq',q:'📜 Văn Miếu Quốc Tử Giám xây dựng năm nào?',opts:['968','1010','1070','1128'],ans:2},
      {type:'mcq',q:'⚔️ Trận Như Nguyệt 1077 diễn ra trên sông nào?',opts:['Sông Hồng','Sông Lam','Sông Cầu','Sông Bạch Đằng'],ans:2},
      {type:'mcq',q:'🌊 Nhà Trần dùng kế gì đánh Mông Nguyên lần 2?',opts:['Vườn không nhà trống','Phục kích rừng núi','Tấn công bất ngờ','Cầu viện nước ngoài'],ans:0},
      {type:'mcq',q:'🌟 Tên thật của vua Quang Trung là?',opts:['Nguyễn Huệ','Nguyễn Nhạc','Nguyễn Lữ','Nguyễn Ánh'],ans:0},
      {type:'mcq',q:'📚 Hội Việt Nam Cách mạng Thanh niên do ai thành lập?',opts:['Phan Bội Châu','Hồ Chí Minh','Trần Phú','Nguyễn Thái Học'],ans:1},
      {type:'mcq',q:'⚔️ Trận Điện Biên Phủ kéo dài bao nhiêu ngày?',opts:['35 ngày','45 ngày','55 ngày','65 ngày'],ans:2},
      ...
      {type:'mcq',q:'🗺️ Ai ký Hiệp ước Nhâm Tuất 1862 nhượng đất cho Pháp?',opts:['Vua Tự Đức','Vua Hàm Nghi','Vua Thành Thái','Vua Khải Định'],ans:0},
    ],
    5:[ // CẤP 5 — Thần Thánh (10 tuổi)
      {type:'mcq',q:'📜 Văn Miếu mở trường dạy học năm nào?',opts:['1070','1076','1086','1156'],ans:1},
      {type:'mcq',q:'⚔️ Ai là Thái sư đầu tiên của triều Trần?',opts:['Trần Thủ Độ','Trần Quốc Tuấn','Trần Ích Tắc','Trần Nhân Tông'],ans:0},
      {type:'mcq',q:'🏹 Khởi nghĩa Lam Sơn bắt đầu năm nào?',opts:['1407','1418','1427','1428'],ans:1},
      {type:'mcq',q:'🗺️ Ai là đại tướng chỉ huy chiến dịch Điện Biên Phủ?',opts:['Hồ Chí Minh','Võ Nguyên Giáp','Trường Chinh','Phạm Văn Đồng'],ans:1},
      {type:'mcq',q:'📚 Bác Hồ sinh năm nào?',opts:['1888','1890','1892','1894'],ans:1},
      {type:'mcq',q:'⚔️ Phong trào Cần Vương do vua nào phát động?',opts:['Vua Hàm Nghi','Vua Tự Đức','Vua Đồng Khánh','Vua Duy Tân'],ans:0},
      ...
      {type:'mcq',q:'🌟 Hiệp định Paris 1973 kết thúc chiến tranh với nước nào?',opts:['Pháp','Mỹ','Trung Quốc','Nhật Bản'],ans:1},
    ],
  },

  literature:{
    1:[ // CẤP 1 — Tân Binh (6-7 tuổi): Tiếng Việt cơ bản
      {type:'mcq',q:'🔤 "Bút" và "vở" dùng để làm gì?',opts:['Ăn uống','Học bài viết chữ','Chơi đùa','Nấu ăn'],ans:1},
      ...
      {type:'mcq',q:'🐾 Con mèo kêu tiếng gì?',opts:['Gâu gâu','Meo meo','Ủn ỉn','Ò ó o'],ans:1},
      {type:'mcq',q:'🌈 Câu nào có từ chỉ màu sắc?',opts:['Con mèo chạy nhanh','Bầu trời màu xanh','Bạn học chăm chỉ','Cô giáo dạy giỏi'],ans:1},
      {type:'mcq',q:'📚 Câu chuyện "Tấm Cám" kể về ai?',opts:['Hai anh em','Hai chị em','Mẹ và con','Ông và cháu'],ans:1},
      {type:'mcq',q:'🔤 Chữ cái đầu tiên trong bảng chữ cái là gì?',opts:['A','B','C','Ă'],ans:0},
    ...
    2:[ // CẤP 2 — Chiến Binh (7-8 tuổi): Từ loại, câu đơn giản
      {type:'mcq',q:'📝 Từ nào là danh từ?',opts:['chạy','đẹp','bàn','nhanh'],ans:2},
      {type:'mcq',q:'🌿 Từ nào là động từ?',opts:['hoa','học','đỏ','nhà'],ans:1},
      {type:'mcq',q:'🎨 Từ nào là tính từ?',opts:['bút','viết','xanh','sách'],ans:2},
      {type:'mcq',q:'🔤 Câu "Em đi học" có mấy từ?',opts:['2 từ','3 từ','4 từ','5 từ'],ans:1},
      {type:'mcq',q:'📚 Trong truyện "Cô bé Lọ Lem", cô bé đến dự gì?',opts:['Tiệc sinh nhật','Dạ hội hoàng cung','Lễ hội làng','Cuộc thi hát'],ans:1},
      {type:'mcq',q:'🌙 "Ông trăng" trong câu "Ông trăng sáng tỏ" là hình ảnh gì?',opts:['Ông già','Mặt trăng','Ngôi sao','Đèn đường'],ans:1},
    ...
    3:[ // CẤP 3 — Anh Hùng (8-9 tuổi): Tập đọc, hiểu văn
      {type:'mcq',q:'📖 Truyện "Dế Mèn phiêu lưu ký" do ai viết?',opts:['Nguyễn Du','Tô Hoài','Nguyên Hồng','Nam Cao'],ans:1},
      {type:'mcq',q:'📝 Đoạn văn mô tả cảnh vật gọi là?',opts:['Kể chuyện','Miêu tả','Thuyết minh','Nghị luận'],ans:1},
      {type:'mcq',q:'🌸 Câu "Bông hoa như ngôi sao" dùng biện pháp gì?',opts:['Ẩn dụ','So sánh','Nhân hóa','Điệp ngữ'],ans:1},
      {type:'mcq',q:'📚 "Kiều" là nhân vật trong tác phẩm nào?',opts:['Lục Vân Tiên','Truyện Kiều','Chinh Phụ Ngâm','Cung Oán Ngâm Khúc'],ans:1},
      {type:'mcq',q:'🎭 Câu "Con chim hót líu lo" có từ tượng thanh nào?',opts:['con chim','hót','líu lo','câu'],ans:2},
      {type:'mcq',q:'✍️ Phần mở bài trong văn kể chuyện nên làm gì?',opts:['Kể diễn biến chi tiết','Giới thiệu câu chuyện','Nêu kết thúc','Viết cảm nghĩ'],ans:1},
      ...
      {type:'mcq',q:'🔤 Từ "mặt trời" trong "Mặt trời của mẹ, con nằm trên lưng" nghĩa là gì?',opts:['Mặt trời thật','Đứa con yêu quý','Ánh sáng','Ngọn lửa'],ans:1},
    ],
    4:[ // CẤP 4 — Huyền Thoại (9-10 tuổi)
      {type:'mcq',q:'📖 "Truyện Kiều" có bao nhiêu câu thơ lục bát?',opts:['2.214','3.254','3.976','4.112'],ans:1},
      {type:'mcq',q:'✍️ Nguyễn Du sống vào triều đại nào?',opts:['Nhà Lê','Nhà Nguyễn','Thời Pháp thuộc','Nhà Trần'],ans:1},
      {type:'mcq',q:'📝 Thể thơ lục bát có số tiếng mỗi cặp câu là?',opts:['5-7','6-8','7-7','4-8'],ans:1},
      {type:'mcq',q:'🎭 Câu "Bác Hồ như ánh mặt trời" dùng biện pháp gì?',opts:['Ẩn dụ','So sánh','Nhân hóa','Hoán dụ'],ans:1},
      {type:'mcq',q:'📚 Ai viết bài thơ "Đêm nay Bác không ngủ"?',opts:['Tố Hữu','Minh Huệ','Chính Hữu','Huy Cận'],ans:1},
      {type:'mcq',q:'🌸 "Đất nước mình ngộ quá phải không anh" là thơ của ai?',opts:['Trần Đăng Khoa','Nguyễn Nhật Ánh','Lê Minh Quốc','Thùy Linh'],ans:2},
      ...
      {type:'mcq',q:'🔤 Từ láy trong câu "Cô bé thỏ thẻ kể chuyện" là?',opts:['cô bé','thỏ thẻ','kể','chuyện'],ans:1},
    ],
    5:[ // CẤP 5 — Thần Thánh (10 tuổi)
      {type:'mcq',q:'📖 "Lục Vân Tiên" do ai sáng tác?',opts:['Nguyễn Du','Nguyễn Đình Chiểu','Hồ Xuân Hương','Đoàn Thị Điểm'],ans:1},
      {type:'mcq',q:'✍️ Hồ Xuân Hương nổi tiếng với thể thơ gì?',opts:['Lục bát','Thất ngôn bát cú','Song thất lục bát','Ngũ ngôn'],ans:1},
      {type:'mcq',q:'📝 "Chinh phụ ngâm" do ai dịch sang tiếng Việt?',opts:['Nguyễn Du','Đoàn Thị Điểm','Hồ Xuân Hương','Nguyễn Gia Thiều'],ans:1},
      {type:'mcq',q:'🎭 Biện pháp "vắt dòng" trong thơ là gì?',opts:['Câu thơ dài','Ý thơ tiếp sang dòng sau','Lặp lại từ','Dùng từ lạ'],ans:1},
      {type:'mcq',q:'📚 Ai được mệnh danh là "thần đồng thơ" với bài thơ về hạt gạo?',opts:['Tố Hữu','Trần Đăng Khoa','Xuân Diệu','Huy Cận'],ans:1},
      {type:'mcq',q:'🌸 "Thương vợ" là bài thơ của?',opts:['Nguyễn Khuyến','Tú Xương','Tản Đà','Phan Bội Châu'],ans:1},
      ...
      {type:'mcq',q:'🔤 "Đất Nước" là bài thơ nổi tiếng của?',opts:['Tố Hữu','Nguyễn Khoa Điềm','Chế Lan Viên','Xuân Quỳnh'],ans:1},
    ],
  },
  ...
  civic:{
    1:[ // CẤP 1 — Tân Binh (6-7 tuổi): Quy tắc ứng xử cơ bản
      ...
      {type:'mcq',q:'🤝 Khi gặp người lớn tuổi, em nên làm gì?',opts:['Bỏ qua không chào','Chào hỏi lễ phép','Chạy thật nhanh','Nhìn chằm chằm'],ans:1},
      {type:'mcq',q:'🏫 Ở trường, em nên làm gì khi thầy cô đang giảng bài?',opts:['Nói chuyện riêng','Chú ý lắng nghe','Nghịch điện thoại','Ngủ gật'],ans:1},
      {type:'mcq',q:'🌿 Em nên làm gì để bảo vệ môi trường?',opts:['Vứt rác bừa bãi','Bỏ rác vào thùng','Chặt cây lấy củi','Đốt rác ở sân'],ans:1},
      {type:'mcq',q:'🚸 Khi qua đường, em cần làm gì?',opts:['Chạy thật nhanh','Nhìn hai bên rồi đi qua','Đi giữa đường','Đóng mắt bước'],ans:1},
      {type:'mcq',q:'💧 Tại sao cần tiết kiệm nước?',opts:['Vì nước đắt tiền','Vì nước không tái tạo nhanh','Vì uống nhiều không tốt','Vì không cần thiết'],ans:1},
    ...
    2:[ // CẤP 2 — Chiến Binh (7-8 tuổi)
      {type:'mcq',q:'🏛️ Ai là người đứng đầu nhà nước Việt Nam hiện nay?',opts:['Thủ tướng','Chủ tịch nước','Tổng bí thư','Chủ tịch Quốc hội'],ans:1},
      {type:'mcq',q:'🌟 Hội đồng nhân dân là cơ quan gì?',opts:['Cơ quan hành pháp','Cơ quan tư pháp','Cơ quan đại diện nhân dân','Cơ quan an ninh'],ans:2},
      {type:'mcq',q:'📜 Hiến pháp Việt Nam quy định điều gì?',opts:['Quy tắc giao thông','Quyền và nghĩa vụ cơ bản','Điều lệ trường học','Luật thuế'],ans:1},
      {type:'mcq',q:'🤝 Quyền trẻ em bao gồm quyền gì?',opts:['Chỉ quyền học','Chỉ quyền vui chơi','Được học, vui chơi, được bảo vệ','Chỉ quyền ăn no'],ans:2},
      {type:'mcq',q:'🌿 Bảo vệ môi trường là trách nhiệm của ai?',opts:['Chỉ nhà nước','Chỉ các nhà khoa học','Mọi người dân','Chỉ người lớn'],ans:2},
      {type:'mcq',q:'🚑 Số điện thoại nào gọi cấp cứu y tế?',opts:['113','114','115','112'],ans:2},
      ...
      {type:'mcq',q:'💚 Trẻ em có quyền được bảo vệ khỏi điều gì?',opts:['Lao động nhẹ','Học tập','Bạo lực và xâm hại','Tham gia hoạt động'],ans:2},
    ],
    3:[ // CẤP 3 — Anh Hùng (8-9 tuổi)
      {type:'mcq',q:'📜 Luật Giáo dục quy định độ tuổi học mẫu giáo là?',opts:['2-5 tuổi','3-6 tuổi','4-7 tuổi','5-8 tuổi'],ans:1},
      {type:'mcq',q:'🌐 Quyền bình đẳng có nghĩa là?',opts:['Mọi người đều giống nhau','Mọi người đều có quyền như nhau','Mọi người đều giàu','Không ai được làm sai'],ans:1},
      {type:'mcq',q:'🏦 Thuế là gì?',opts:['Tiền phạt vi phạm','Khoản đóng góp cho nhà nước để phát triển xã hội','Tiền vay ngân hàng','Tiền ủng hộ từ thiện'],ans:1},
      ...
      {type:'mcq',q:'⚖️ Tư pháp là cơ quan nào?',opts:['Chính phủ','Quốc hội','Tòa án','Công an'],ans:2},
      ...
      {type:'mcq',q:'🌍 Việt Nam gia nhập Liên Hợp Quốc năm nào?',opts:['1954','1969','1977','1986'],ans:2},
    ],
    4:[ // CẤP 4 — Huyền Thoại (9-10 tuổi)
      {type:'mcq',q:'🏛️ Hệ thống chính trị Việt Nam bao gồm mấy nhánh quyền lực?',opts:['2','3','4','5'],ans:1},
      {type:'mcq',q:'📊 GDP là viết tắt của?',opts:['Tổng sản phẩm quốc dân','Tổng sản phẩm quốc nội','Tốc độ tăng trưởng','Ngân sách nhà nước'],ans:1},
      {type:'mcq',q:'🌐 Việt Nam là thành viên của tổ chức nào?',opts:['G7','NATO','ASEAN và WTO','OPEC'],ans:2},
      {type:'mcq',q:'⚖️ Pháp luật có đặc điểm gì khác quy tắc đạo đức?',opts:['Không ai phải tuân theo','Có tính bắt buộc, được nhà nước bảo đảm','Chỉ áp dụng với người giàu','Có thể thay đổi tùy người'],ans:1},
      {type:'mcq',q:'🌿 Ai chịu trách nhiệm bảo vệ môi trường theo Luật?',opts:['Chỉ các công ty','Chỉ nhà nước','Tất cả tổ chức và cá nhân','Chỉ nông dân'],ans:2},
      {type:'mcq',q:'📜 Hiến pháp Việt Nam hiện hành được ban hành năm nào?',opts:['1992','2001','2013','2018'],ans:2},
      ...
      {type:'mcq',q:'🤝 Nghĩa vụ nào sau đây là của công dân khi đủ tuổi?',opts:['Không cần đóng thuế','Nghĩa vụ quân sự','Chỉ đi bầu cử','Không phải thực hiện gì'],ans:1},
    ],
    5:[ // CẤP 5 — Thần Thánh (10 tuổi)
      {type:'mcq',q:'🌐 Số thành viên của Liên Hợp Quốc hiện nay là khoảng?',opts:['153','183','193','213'],ans:2},
      {type:'mcq',q:'📊 Chỉ số HDI đo lường điều gì?',opts:['Tăng trưởng kinh tế','Phát triển con người','Mức độ dân chủ','Tự do báo chí'],ans:1},
      {type:'mcq',q:'⚖️ Nhà nước pháp quyền có đặc điểm cốt lõi là?',opts:['Vua đứng đầu','Luật pháp cao hơn mọi quyền lực','Quân đội kiểm soát','Đảng duy nhất'],ans:1},
      {type:'mcq',q:'🌿 Thỏa thuận Paris về biến đổi khí hậu ký năm?',opts:['2005','2010','2015','2020'],ans:2},
      {type:'mcq',q:'🏛️ Mô hình "tam quyền phân lập" chia quyền lực thành?',opts:['Lập pháp, Hành pháp, Tư pháp','Trung ương, Địa phương, Cơ sở','Đảng, Nhà nước, Nhân dân','Hành chính, Kinh tế, Xã hội'],ans:0},
      {type:'mcq',q:'📜 Công ước UNCRC (Quyền Trẻ Em) có bao nhiêu điều?',opts:['34','44','54','64'],ans:1},
      ...
      {type:'mcq',q:'🌍 Khủng hoảng khí hậu toàn cầu chủ yếu do nguyên nhân nào?',opts:['Động đất núi lửa','Phát thải khí nhà kính','Thay đổi quỹ đạo Trái Đất','Hoạt động Mặt Trời'],ans:1},
    ],
  },

  english:{
    1:[ // CẤP 1 — Tân Binh (6-7 tuổi): Số, màu, vật dụng
      {type:'mcq',q:'🔤 "Apple" có nghĩa là gì?',opts:['Chuối','Táo','Cam','Dâu'],ans:1},
      {type:'mcq',q:'🎨 "Red" có nghĩa là màu gì?',opts:['Xanh','Vàng','Đỏ','Trắng'],ans:2},
      {type:'mcq',q:'🔢 "Three" là số mấy?',opts:['1','2','3','4'],ans:2},
      {type:'mcq',q:'🐱 "Cat" có nghĩa là gì?',opts:['Chó','Mèo','Gà','Chim'],ans:1},
      {type:'mcq',q:'🌞 "Sun" có nghĩa là gì?',opts:['Mặt trăng','Ngôi sao','Mặt trời','Đám mây'],ans:2},
      {type:'mcq',q:'🎒 "School bag" có nghĩa là gì?',opts:['Sách vở','Cặp sách','Bàn học','Bút chì'],ans:1},
      {type:'mcq',q:'🔤 Con số "Five" là?',opts:['3','4','5','6'],ans:2},
    ...
    2:[ // CẤP 2 — Chiến Binh (7-8 tuổi): Câu đơn, động từ cơ bản
      {type:'mcq',q:'🔤 "I am a student" nghĩa là?',opts:['Tôi là giáo viên','Tôi là học sinh','Tôi là bác sĩ','Tôi là công nhân'],ans:1},
      {type:'mcq',q:'🌈 "The sky is blue" nghĩa là?',opts:['Trời đang mưa','Bầu trời màu xanh','Biển rất đẹp','Hoa màu xanh'],ans:1},
      {type:'mcq',q:'🔢 "How old are you?" hỏi về điều gì?',opts:['Tên','Tuổi','Địa chỉ','Nghề nghiệp'],ans:1},
      {type:'mcq',q:'📚 "This is my book" nghĩa là?',opts:['Đây là sách của bạn','Đây là sách của tôi','Đây là sách của thầy','Đây là sách đẹp'],ans:1},
      {type:'mcq',q:'🌞 "What is the weather like?" hỏi về gì?',opts:['Thời tiết','Giờ giấc','Địa điểm','Màu sắc'],ans:0},
      {type:'mcq',q:'🔤 "We" có nghĩa là?',opts:['Tôi','Bạn','Chúng tôi/ta','Họ'],ans:2},
    ...
    3:[ // CẤP 3 — Anh Hùng (8-9 tuổi): Thì hiện tại, từ vựng mở rộng
      {type:'mcq',q:'🔤 "She plays piano every day" dùng thì gì?',opts:['Quá khứ','Hiện tại đơn','Tương lai','Tiếp diễn'],ans:1},
      {type:'mcq',q:'📝 Chọn từ đúng: "He ___ to school by bus"',opts:['go','goes','going','gone'],ans:1},
      {type:'mcq',q:'🌍 "Where do you live?" hỏi về gì?',opts:['Tuổi','Nghề nghiệp','Nơi ở','Sở thích'],ans:2},
      {type:'mcq',q:'🔢 "There are twelve months in a year" — "twelve" là?',opts:['10','11','12','13'],ans:2},
      {type:'mcq',q:'🌸 "Beautiful" có nghĩa là?',opts:['Xấu','Đẹp','Nhanh','Chậm'],ans:1},
      ...
      {type:'mcq',q:'🔤 "Happy" trái nghĩa là?',opts:['Joyful','Sad','Excited','Fun'],ans:1},
    ],
    4:[ // CẤP 4 — Huyền Thoại (9-10 tuổi)
      {type:'mcq',q:'📝 "She was reading when I called" dùng thì gì?',opts:['Hiện tại đơn','Quá khứ đơn','Quá khứ tiếp diễn','Tương lai'],ans:2},
      {type:'mcq',q:'🔤 "Although it rained, we went out" — "although" có nghĩa?',opts:['Vì vậy','Mặc dù','Vì','Khi'],ans:1},
      {type:'mcq',q:'📚 Câu bị động của "Tom wrote this letter" là?',opts:['This letter was written by Tom','Tom is writing this letter','This letter writes Tom','Tom have written this letter'],ans:0},
      {type:'mcq',q:'🌍 "Would you like some tea?" là câu gì?',opts:['Câu hỏi thông tin','Lời đề nghị/mời','Câu lệnh','Câu cảm thán'],ans:1},
      {type:'mcq',q:'🔢 "A dozen" là bao nhiêu?',opts:['10','11','12','13'],ans:2},
      {type:'mcq',q:'📝 Chọn đúng: "Neither he nor she ___ right"',opts:['are','were','is','am'],ans:2},
      ...
      {type:'mcq',q:'🌸 "I\'m looking forward to meeting you" — "looking forward to" nghĩa là?',opts:['Sợ hãi khi','Mong đợi được','Buồn bã khi','Ngạc nhiên khi'],ans:1},
    ],
    5:[ // CẤP 5 — Thần Thánh (10 tuổi)
      {type:'mcq',q:'📝 "Had she known the truth, she would not have lied" là câu điều kiện loại?',opts:['Loại 1','Loại 2','Loại 3','Hỗn hợp'],ans:2},
      {type:'mcq',q:'🔤 "Despite the heavy rain, they continued" — "despite" giống với?',opts:['Because of','Although','Therefore','However'],ans:1},
      {type:'mcq',q:'📚 Tìm lỗi: "She suggested to go to the cinema"',opts:['"She" sai','Nên là "suggested going"','Nên là "went"','Không có lỗi'],ans:1},
      {type:'mcq',q:'🌍 "The more you practice, the better you get" là cấu trúc gì?',opts:['Câu điều kiện','So sánh kép','Câu bị động','Câu gián tiếp'],ans:1},
      {type:'mcq',q:'🔢 "Millennium" có nghĩa là bao nhiêu năm?',opts:['100 năm','500 năm','1000 năm','10000 năm'],ans:2},
      {type:'mcq',q:'📝 "It\'s time you went to bed" — "went" ở đây dùng ở dạng nào?',opts:['Hiện tại','Quá khứ giả định','Tương lai','Nguyên thể'],ans:1},
      ...
      {type:'mcq',q:'🌸 "She\'s the spitting image of her mother" nghĩa là?',opts:['Cô ấy xấu như mẹ','Cô ấy giống mẹ như đúc','Cô ấy yêu mẹ nhiều','Cô ấy giỏi hơn mẹ'],ans:1},
    ],
  },
};
// ═══════════════════════════════════════════
